...
// let date = new Date(2020, 2, 22, 12, 35, 30);
// console.log(date.toLocaleString());

// let date = new Date("2022-12-04");
// console.log(date);

// let date = new Date("2020-12-04 10:30:00");
// console.log(date.toLocaleString());

// let date = new Date("2020-12-4 10:30:00");
// console.log(date.toLocaleString());

// let date = new Date("nfjkldsnlkfj 2020-12-4 10:30:00");
// console.log(date.toLocaleString());
